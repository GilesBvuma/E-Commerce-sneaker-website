...
<html lang="en">
  ...
  <body>
    ...
    <div class="groups">
      <a href="./female.php"><button>Female</button></a>
      <a href="./kids.php"><button>Kids</button></a>
...
<article class="card" style="--isPopular: true">
  ...
  <div class="image">
    <img src="./images/Air_Jordan_4.png" alt="jordan 4 blue"/>
  </div>
  <div class="info">
    <div class="name">Jordan 4 Retro</div>
    <div class="price">
...
      </article>
  ...
  <article class="card" style="--isNew: true">
    ...
    <div class="image">
      <img src="./images/SCARPE.png" alt="jordan 4 blue" class="j4-orange" />
    </div>
    <div class="info">
      <div class="name">Nike_-_Air_Force 1</div>
      <div class="price">
