...
<html lang="en">
  ...
  <body>
    ...
    <div class="groups">
      <a href="./female.php"><button>Male</button></a>
      <a href="./kids.php"><button>Female</button></a>
  ...
  <article class="card" style="--isNew: true">
    ...
    <div class="image">
      <img src="./images/c.png" alt="jordan 4 blue" class="j4-orange" />
    </div>
    <div class="info">
...
<article class="card" style="--isNew: true">
  ...
  <div class="image">
    <img src="./images/chil.png" alt="jordan 4 blue" class="Airmax"/>
  </div>
  <div class="info">
...
<article class="card" style="--isPopular: true">
  ...
  <div class="image">
    <img src="./images/ac.png" alt="jordan 4 blue"/>
  </div>
  <div class="info">
...
      </article>
    ...
    <section class="popular-products">
      <div class="my-cards">
        <article class="card" style="--isPopular: true">
          ...
          <div class="image">
            <img src="./images/ccc.png" alt="jordan 4 blue" />
          </div>
          <div class="info">
            <div class="name">Jordan 4 Retro</div>
            <div class="price">
  ...
  <article class="card" style="--isNew: true">
    ...
    <div class="image">
      <img src="./images/cc.png" alt="jordan 4 blue" class="j4-orange" />
    </div>
    <div class="info">
